/*
Nume: Spataru Mara-Andreea
Grupa: 141
Tutore laborator: Gabriel Majeri
Compilator: gcc.exe (GCC) 11.2.0 (VS Code)
*/   
...
istream& operator>>(istream& is, DrumNational& dn){
    ...
    cout<<"Numarul de tronsoane ale drumului este:\n";
    is>>dn.nr_tronsoane;
    cout<<"Numarul de judete prin care drumul trece:\n";
    is>>dn.nr_judete;
    return is;
}
ostream& operator<<(ostream& os, DrumNational& dn){
    os<<"Denumirea drumului este: "<<dn.denumire<<'\n';
    os<<"Lungimea drumului este: "<<dn.lungime<<'\n';
    os<<"Numarul de tronsoane ale drumului: "<<dn.nr_tronsoane<<'\n';
    os<<"Numarul de judete prin care drumul trece: "<<dn.nr_judete<<'\n';
    return os;
}
...
ostream& operator<<(ostream& os, DrumEuropean& de){
    os<<"Denumirea drumului este: "<<de.denumire<<'\n';
    os<<"Lungimea drumului este: "<<de.lungime<<'\n';
    os<<"Numarul de tronsoane ale drumului: "<<de.nr_tronsoane<<'\n';
    os<<"Numarul de tari prin care drumul trece: "<<de.nr_tari<<'\n';
    return os;
}
istream& operator>>(istream& is, DrumEuropean& de){
    ...
    cout<<"Numarul de tronsoane ale drumului este:\n";
    is>>de.nr_tronsoane;
    cout<<"Numarul de tari prin care trece drumul:\n";
    is>>de.nr_tari;
    return is;
}
