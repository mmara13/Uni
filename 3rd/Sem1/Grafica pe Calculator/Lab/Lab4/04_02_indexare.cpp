...
glm::mat4
matrTransl, matrScale, resizeMatrix, myMatrix;
...
void RenderFunction(void)
{
	...
	///matrice pentru scalare cu factori (2.0, 0.5)
	matrScale = glm::scale(glm::mat4(1.0f), glm :: vec3(2.0, 0.5, 1.0));
	//matrice pentru translatie de vector (100,100)
	matrTransl = glm:: translate(glm :: mat4(1.0f), glm :: vec3(100, 100, 0));
	// intai scalare apoi translatie(cu mix de culroi)
		myMatrix = resizeMatrix * matrScale * matrTransl;
	int codCol = 5;
	glUniformMatrix4fv(myMatrixLocation, 1, GL_FALSE, &myMatrix[0][0]);
	//glUniform1i(codColLocation, codCol);
	glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, (void*)(0));
	//intai translatie apoi scalare (texturat)
