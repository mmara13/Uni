...
void CreateVBO(void)
{
	...
	//  PRIMUL VBO - corespunde unei barci maro
	//  Coordonatele varfurilor;
	static const GLfloat Vertices1[] =
	{
		-50.5f, -20.5f, 0.0f, 1.0f,
		-25.0f, -20.5f, 0.0f, 1.0f,
		-10.0f, 0.0f, 0.0f, 1.0f,
		-70.0f, 0.0f, 0.0f, 1.0f, //aceste 4 puncte alcatuiesc trapezul care e barca
	};

	//	Culorile ca atribute ale varfurilor;
	static const GLfloat Colors1[] =
	{
		0.55f, 0.27f, 0.07f, 1.0f, //maro pt barca
	...
	{
		0.9f, 0.8f, 0.6f, 1.0f,  //casa stg jos
		0.9f, 0.8f, 0.6f, 1.0f,  //casa dr jos
		0.9f, 0.8f, 0.6f, 1.0f,  //casa dr sus
		0.9f, 0.8f, 0.6f, 1.0f,  //casa stg sus
		0.8f, 0.0f, 0.0f, 1.0f,  //vf acoperis
		0.3f, 0.2f, 0.1f, 1.0f,  
		0.3f, 0.2f, 0.1f, 1.0f,  
		0.3f, 0.2f, 0.1f, 1.0f, 
		0.3f, 0.2f, 0.1f, 1.0f,  //usa
	};
	...
	{
		0, 1, 2,
		0, 2, 3, //primele doua triunghiuri pt casa
		2, 4, 3, //acoperis
		5, 6, 7, //primul triunghi pt usa
		5, 7, 8, //al doilea triunghi pt usa casei
	};
